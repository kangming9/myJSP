...
public class AdoptVO {
	...
	private int adopt_member_num;
	private int adopt_pet_num;
	...
	public int getAdopt_member_num() {
		return adopt_member_num;
	}
	public void setAdopt_member_num(int adopt_member_num) {
		this.adopt_member_num = adopt_member_num;
	}
	public int getAdopt_pet_num() {
		return adopt_pet_num;
	}
	public void setAdopt_pet_num(int adopt_pet_num) {
		this.adopt_pet_num = adopt_pet_num;
	}
